...
class ClientSocket:
    def __init__(self, ip, port):
        ...
        rospy.init_node('imgSender2')
        rospy.Subscriber('/camera_down/image_raw/compressed',CompressedImage,self.img_callback,queue_size=1)
        rospy.spin()
...
#                        print('detected more then two but among them are marker(one)')
    ...
    def img_pub(self):
        while True:
            ...
            resize_frame = cv2.resize(frame, dsize=(160*3, 90*3), interpolation=cv2.INTER_AREA)
